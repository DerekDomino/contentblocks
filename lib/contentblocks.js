...
module.exports = function (params) {
    ...
    var getContent = params.getContent;
                ...
                app.render(view, options, function (err, html) {
                    ...
                    if (!err) {
                        ...
                        contentBlocks.each(function (i, elem) {
                            ...
                            console.log('Registration for db:', id);
                        ...
                        console.log('');
                        console.log('**Error before contentblocks:**');
                        console.log(err);
                        next(err);
                    }
...
//                            else {
                                ...
                                getContent(contentBlockItem.id, function (result) {
                                    if (result != null && result.length > 0) {
                                        // Cache the result.
